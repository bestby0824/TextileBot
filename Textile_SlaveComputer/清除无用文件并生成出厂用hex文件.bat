...
cd Project\Objects
del D:\workspace\SVN\Release\TextileBot_V2\Textile_SlaveComputer\Hex\*.hex

echo f | xcopy TextileSlaveBD.hex %~dp0\TextileSlaveBD_%str_A%_%str_B%_%str_C%.hex /S /F /R /Y /E
