...
void CanTaskProcess ( void )
{
    ...
    else if ( ( u32CanTaskCnt % 10 ) == 2 )  //10ms一次，反馈状态2
    {
...
void CanFBDataObtain ( void )
{
    ...
    RegReal_BoardState2.u16Ref1 = Encoder_Handle.linear_distance;
    RegReal_BoardState2.u16Ref2 = Encoder_Handle.current_position;
    RegReal_BoardState2.u16Ref3 = Encoder_Handle.revolution_count;
}
/**
        ...
        if ( RegReal_ParamManageCmd.u16SN != RegReal_ParamManageFB.u16SN )  //新SN指令
        {
            ...
            else if ( RegReal_ParamManageCmd.u16Mode == Para_WRITE )
            {
                ...
                if ( ( g_sMotorCmd.eCmdMode == CmdMode_FreeStop ) || ( g_sMotorCmd.eCmdMode == CmdMode_Fault ) )
                {
                    ...
                    case 1046:
                    {
                        ParamHandle_Steer.Reg_CtrlDeadZone = _IQsat ( RegReal_ParamManageCmd.u16Value, _IQ ( 0.00555 ), 0 );
                    }
                    break;
                    case 1047:
                    {
                        ParamHandle_Steer.Reg_PosDeadZone = _IQsat ( RegReal_ParamManageCmd.u16Value, _IQ ( 0.00555 ), 0 );
                    }
                    break;
                    case 1048:
                    {
                        ParamHandle_Steer.Reg_PosMax = _IQsat ( RegReal_ParamManageCmd.u16Value, _IQ ( 0.5 ), 0 );
                    }
                    break;
                    case 1049:
                    {
                        ParamHandle_Steer.Reg_PosMin = _IQsat ( RegReal_ParamManageCmd.u16Value, _IQ ( 0.5 ), 0 );
                    }
                    break;
                    case 1053:
                    {
