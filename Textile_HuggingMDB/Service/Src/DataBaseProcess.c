...
static void SteerDataBaseInit ( void )
{
    ...
    ParamHandle_Steer.Reg_CtrlDeadZone = 0;
    ParamHandle_Steer.Reg_PosDeadZone = 0;
    ParamHandle_Steer.Reg_PosMax = 765;
    ParamHandle_Steer.Reg_PosMin = 10;
    ParamHandle_Steer.Reg_TorqueMax = 0;
    ParamHandle_Steer.Reg_TorqueMin = 0;
    ParamHandle_Steer.Reg_CaliTimeOut = 18000;
    ParamHandle_Steer.Reg_RunTimeOut = 18000;
    ParamHandle_Steer.Reg_RC_Spdmax = _IQ ( 0.5 );
}
//-----------------------End of file------------------------------------------
/** @} */ /* End of group */
