...
#define SoftVer_B                               1  //范围为0~255，B为功能版本，增加功能需变化B项
...
//-------------------- 350-253寄存器，其他相关参数 -------------------------
    ...
    uint16_t Reg_AccSpd;                     //76：加速加速度，65535代表最大转速*0.25rpm/S^2
    uint16_t Reg_DecSpd;                     //77：减速加速度，65535代表最大转速*0.25rpm/S^2
...
#define Dev_Ver         Dev_Textile_Telescopic
...
#define ParamDefault    { \
    ...
    _IQ ( 0.04 ),/* Reg_PI_ID_KP*/\
    _IQ ( 0.025 ),/* Reg_PI_ID_KI*/\
    _IQ ( 0.04 ),/* Reg_PI_IQ_KP*/\
    _IQ ( 0.025 ),/* Reg_PI_IQ_KI*/\
    ...
    _IQ ( 0.002 ),/* Reg_CtrlDeadZone*/\
    _IQ ( 0.002 ),/* Reg_PosDeadZone*/\
    \
    60000,/* Reg_PosMax*/\
    0,/* Reg_PosMin*/\
    0,/* Reg_TorqueMax*/\
    0,/* Reg_TorqueMin*/\
    10000,/* Reg_CaliTimeOut*/\
    10000,/* Reg_RunTimeOut*/\
    ...
    _IQ(1440),/*Reg_Tag30*/\
    _IQ(1488),/*Reg_Tag31*/\
    _IQ(0.0025),/* Reg_AccSpd*/\
    _IQ(0.0025),/* Reg_DecSpd*/\
