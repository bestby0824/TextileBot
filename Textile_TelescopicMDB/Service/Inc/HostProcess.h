...
/*******************指令包ID********************/
#define Reg_PosCtrlCmd          0x120
#define Reg_SensorCaliCmd       0x121
#define Reg_FaultClearCmd       0x122
#define Reg_ParamManageCmd      0x123
#define Reg_HeartCmd            0x124
#define Reg_ResetCmd            0x125
#define Reg_RelayCmd            0x126
/*******************应答包ID********************/
#define Reg_PosCtrlFB           0x300
#define Reg_SensorCaliFB        0x301
#define Reg_FaultClearFB        0x302
#define Reg_ParamManageFB       0x303
#define Reg_HeartFB             0x304
#define Reg_ResetFB             0x305
#define Reg_RelayFB             0x306
#define Reg_FaultCodeFB         0x310
#define Reg_SensorDataFB        0x311
#define Reg_BoardState1         0x312
#define Reg_BoardState2         0x313
#define Reg_BoardState3         0x314
...
typedef struct
{
    uint16_t u16EN;                       //使能
    uint16_t u16SN;                       //SN
    uint16_t u16Mode;                     //控制状态
    uint16_t u16Time;                     //运行时间
} RegDef_RelayCmd;
/*******************FB数据帧详细定义********************/
typedef struct
{
...
typedef struct
{
    uint16_t u16SN;                       //SN
    uint16_t u16EndofCtrl;                //EndofCtrl状态
    uint16_t u16CurSta;                   //当前状态
    uint16_t u16SwichSta;                 //限位开关状态
} RegDef_RelayFB;
...
extern RegDef_RelayCmd RegReal_RelayCmd;
