...
static void SteerDataBaseInit ( void )
{
    ...
    ParamHandle_Steer.Reg_CurrentMax = 1200;
    ParamHandle_Steer.Reg_IdIqMax = _IQ ( 0.5 );
    ParamHandle_Steer.Reg_FaultCheckEnable = 0x00000FFF;
    ParamHandle_Steer.Reg_CtrlDeadZone = _IQ ( 0.002 );
    ParamHandle_Steer.Reg_PosDeadZone = _IQ ( 0.002 );
    ParamHandle_Steer.Reg_PosMax = 60000;
    ParamHandle_Steer.Reg_PosMin = 0;
    ParamHandle_Steer.Reg_TorqueMax = 0;
    ParamHandle_Steer.Reg_TorqueMin = 0;
    ParamHandle_Steer.Reg_CaliTimeOut = 10000;
    ParamHandle_Steer.Reg_RunTimeOut = 10000;
    ParamHandle_Steer.Reg_RC_Spdmax = _IQ ( 0.25 );
    ParamHandle_Steer.Reg_AccSpd = _IQ ( 0.0025 );
    ParamHandle_Steer.Reg_DecSpd = _IQ ( 0.0025 );
}
//-----------------------End of file------------------------------------------
/** @} */ /* End of group */
