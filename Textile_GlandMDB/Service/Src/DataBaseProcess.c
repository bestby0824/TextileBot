...
static void SteerDataBaseInit ( void )
{
    ...
    ParamHandle_Steer.Reg_PI_ID_KP = _IQ ( 0.085 );
    ParamHandle_Steer.Reg_PI_ID_KI = _IQ ( 0.075 );
    ParamHandle_Steer.Reg_PI_IQ_KP = _IQ ( 0.085 );
    ParamHandle_Steer.Reg_PI_IQ_KI = _IQ ( 0.075 );
    ParamHandle_Steer.Reg_AngleMax = _IQ ( 0.1667 );
    ParamHandle_Steer.Reg_SpeedMax = 3000;
    ParamHandle_Steer.Reg_CurrentMax = 300;
    ParamHandle_Steer.Reg_IdIqMax = _IQ ( 0.5 );
    ParamHandle_Steer.Reg_FaultCheckEnable = 0x00000FFF;
    ParamHandle_Steer.Reg_CtrlDeadZone = 1;
    ParamHandle_Steer.Reg_PosDeadZone = 1;
    ParamHandle_Steer.Reg_PosMax = 320;
    ParamHandle_Steer.Reg_PosMin = 8;
    ParamHandle_Steer.Reg_TorqueMax = 50;
    ParamHandle_Steer.Reg_TorqueMin = 30;
    ParamHandle_Steer.Reg_CaliTimeOut = 20000;
    ParamHandle_Steer.Reg_RunTimeOut = 20000;
    ParamHandle_Steer.Reg_RC_Spdmax = _IQ ( 0.25 );
}
//-----------------------End of file------------------------------------------
/** @} */ /* End of group */
