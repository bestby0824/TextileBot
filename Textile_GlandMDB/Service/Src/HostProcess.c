...
uint16_t u16PosCtrlFB_LastSN = 0, u16PosCtrlFB_DelayCnt = 0;
//-------------------- public functions -------------------------------------
...
void CanFBDataObtain ( void )
{
    ...
    if ( g_sMotorCmd.eCmdMode == CmdMode_TorqueCtrl )
    {
        if ( g_sMotor_Info.u16Torque_State )
        {
            RegReal_PosCtrlFB.u16EndofCtrl = CmdStop_Torque;
        }
        else if ( g_sMotorCmd.eRunState == EndOfCtrl )
        {
        ...
        if ( RegReal_ParamManageCmd.u16SN != RegReal_ParamManageFB.u16SN )  //新SN指令
        {
            ...
            else if ( RegReal_ParamManageCmd.u16Mode == Para_WRITE )
            {
                ...
                if ( ( g_sMotorCmd.eCmdMode == CmdMode_FreeStop ) || ( g_sMotorCmd.eCmdMode == CmdMode_Fault ) )
                {
                    ...
                    case 1042:
                    {
                        ParamHandle_Steer.Reg_CurrentMax = _IQsat ( RegReal_ParamManageCmd.u16Value, 300, 0 );
                    }
                    break;
                    case 1046:
                    {
                        ParamHandle_Steer.Reg_CtrlDeadZone = _IQsat ( RegReal_ParamManageCmd.u16Value, 10, 0 );
                    }
                    break;
                    case 1047:
                    {
                        ParamHandle_Steer.Reg_PosDeadZone = _IQsat ( RegReal_ParamManageCmd.u16Value, 10, 0 );
                    }
                    break;
                    case 1048:
                    {
                        ParamHandle_Steer.Reg_PosMax = _IQsat ( RegReal_ParamManageCmd.u16Value, 360, 0 );
                    }
                    break;
                    case 1049:
                    {
                        ParamHandle_Steer.Reg_PosMin = _IQsat ( RegReal_ParamManageCmd.u16Value, 360, 0 );
                    }
                    break;
                    case 1050:
                    {
                        ParamHandle_Steer.Reg_TorqueMax = _IQsat ( RegReal_ParamManageCmd.u16Value, 50, 0 );
                    }
                    break;
                    case 1051:
                    {
                        ParamHandle_Steer.Reg_TorqueMin = _IQsat ( RegReal_ParamManageCmd.u16Value, 50, 0 );
                    }
                    break;
                    case 1052:
                    {
